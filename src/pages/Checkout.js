...
export default function Checkout() {
  ...
  return (
    <>
    <div className='mx-auto max-w-7xl px-4 sm:px-6 px-0 lg:px-0'> 
    <div className='grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5'>
        <div className='lg:col-span-3'>
   <form className='bg-white px-5 py-12 mt-12'>
    <div className='space-y-12'>
     <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-2xl leading-7 text-xl font-semibold text-gray-900">Personal Information</h2>
...
Choose from Existing addresess
          </p>
          <ul role="list" >
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between px-5 gap-x-6 py-5 border-solid border-2 border-gray-200">
