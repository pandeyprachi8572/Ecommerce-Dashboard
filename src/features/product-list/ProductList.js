...
import { ChevronLeftIcon, ChevronRightIcon ,ScaleIcon, StarIcon} from "@heroicons/react/20/solid";
import {
  Dialog,
  DialogBackdrop,
  DialogPanel,
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                          {products.map((product) => (
                            ...
                            <div key={product.id} className="group relative border-solid border-2 p-4 border-gray-200">
                              <div className="min-h-30 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded">
                              <img
                                alt={product.title}
